			...
			$(function(){
				...
				*/
				...
				$("#boardList").on("click","tbody>tr",function(){
					location.href="detail.bo?bno="+$(this).children().eq(0).text(); //상대주소 (현재 주소 마지막 / 뒤에 붙음)
					//location.href="${pageContext.request.contextPath}/detail.bo?bno="+$(this).children().eq(0).text();
					//${pageContext.request.contextPath} : request.getContextPath() 와 동일(프로젝트 루트주소) - 절대주소 (포트번호 뒤에 붙음)
				});
