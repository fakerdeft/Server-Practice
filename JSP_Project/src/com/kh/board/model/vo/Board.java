...
public class Board {
		//category와 boardWriter는 작성시와 조회시 다르게 사용하기 위해 String 타입으로 지정
		...
		public Board(int boardNo, String boardTitle, String boardWriter, int count, Date createDate, String titleImg) {
			super();
			this.boardNo = boardNo;
			this.boardTitle = boardTitle;
			this.boardWriter = boardWriter;
		...
		public String toString() {
			return "Board [boardNo=" + boardNo + ", boardType=" + boardType + ", category=" + category + ", boardTitle="
					+ boardTitle + ", boardContent=" + boardContent + ", boardWriter=" + boardWriter + ", count="
