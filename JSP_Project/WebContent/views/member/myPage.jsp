...
<body>
	...
	<%	
		...
		//필수입력사항이 아닌 데이터는 null값이 들어올수있기 때문에 빈문자열로 치환해준다
		/* if문 활용
    ...
    <div class="outer">
        ...
        <form action="<%=contextPath%>/update.me" id="mypage-form" method="post">
            ...
            <table>
                <tr>
                    <td>*아이디</td>
                    <td><input type="text" name="userId" value="<%=userId%>" required disabled></td>
                    <td></td>
                </tr>
                <tr>
                    <td>*이름</td>
                ...
                <tr>
                    <td>전화번호</td>
                    <td><input type="text" name="phone" value="<%=phone%>" placeholder="-포함 입력해주세요"></td>
                    <td></td>
                </tr>
                <tr>
                    <td>이메일</td>
	      ...
	      <div class="modal-body">
	        ...
	        <form action="<%=contextPath %>/updatePwd.me" method="post">
	         ...
	         function invalidate(){
	         		...
	         		var originPwd = "<%=loginUser.getUserPw()%>"; //세션에 담겨있는 로그인 정보
